...
from mnist.smart_coord import craft_disjoint_mnist_target, craft_first_5_target, craft_last_5_target
from mnist.dataloaders import (
    mnist_combined_train_loader_unseen_noshuffle, 
    mnist_combined_test_loader_unseen,
)
from mnist_cifar10.smart_coord import craft_mnist_cifar10_target, craft_mnist_target, craft_cifar10_target
from mnist_cifar10.dataloaders import (
    mnist_cifar10_single_channel_train_loader_unseen_noshuffle,
    mnist_cifar10_3_channel_train_loader_unseen_noshuffle,
    mnist_cifar10_single_channel_test_loader_unseen,
    mnist_cifar10_3_channel_test_loader_unseen,
)
from fmnist_kmnist.smart_coord import craft_fmnist_kmnist_target, craft_fmnist_target, craft_kmnist_target
from fmnist_kmnist.dataloaders import (
    fmnist_kmnist_train_loader_unseen_noshuffle, 
    fmnist_kmnist_test_loader_unseen,
)
...
def train_model(fpan, trial, device, expert_arch, train_loader, test_loader, upan_test_loader, target_create_fn, upan_target_create_fn, config_args):
    fpan = fpan.to(device)
    ...
    return fpan, test_loss, acc, upan_test_loss, upan_acc
...
def train_fpan(args):
    ...
    if args.fpan_data == "disjoint_mnist":
        train_loaders = [
            mnist_combined_train_loader_unseen_noshuffle(args.batch_size),
            mnist_combined_train_loader_unseen_noshuffle(args.batch_size),
        ]
        test_loaders = mnist_combined_test_loader_unseen(args.test_batch_size)
        upan_test_loaders = [
            mnist_combined_test_loader_unseen(args.test_batch_size),
            mnist_combined_test_loader_unseen(args.test_batch_size),
        ]
        ...
        upan_target_create_fns = [craft_first_5_target, craft_last_5_target]
        fpan_output_size = 2
        fpan_input_channel = 1
    elif args.fpan_data == "mnist_cifar10":
        train_loaders = [
            mnist_cifar10_single_channel_train_loader_unseen_noshuffle(args.batch_size),
            mnist_cifar10_3_channel_train_loader_unseen_noshuffle(args.batch_size),
        ]
        test_loaders = mnist_cifar10_single_channel_test_loader_unseen(args.test_batch_size)
        upan_test_loaders = [
            mnist_cifar10_single_channel_test_loader_unseen(args.test_batch_size),
            mnist_cifar10_3_channel_test_loader_unseen(args.test_batch_size),
        ]
        ...
        upan_target_create_fns = [craft_mnist_target, craft_cifar10_target]
        fpan_output_size = 2
        fpan_input_channel = 1
    elif args.fpan_data == "fmnist_kmnist":
        train_loaders = [
            fmnist_kmnist_train_loader_unseen_noshuffle(args.batch_size),
            fmnist_kmnist_train_loader_unseen_noshuffle(args.batch_size),
        ]
        test_loaders = fmnist_kmnist_test_loader_unseen(args.test_batch_size)
        upan_test_loaders = [
            fmnist_kmnist_test_loader_unseen(args.test_batch_size),
            fmnist_kmnist_test_loader_unseen(args.test_batch_size),
        ]
        ...
        upan_target_create_fns = [craft_fmnist_target, craft_kmnist_target]
        fpan_output_size = 2
        fpan_input_channel = 1
    ...
    for i in range(len(args.seeds)):
        ...
        fpan, fpan_test_loss, fpan_acc, upan_test_loss, upan_acc = train_model(
            ...
            upan_test_loader=upan_test_loaders,
            target_create_fn=target_create_fns,
            upan_target_create_fn=upan_target_create_fns,
            config_args=args,
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_dir", type=str, default="./results/experiments/fpan_unseen_mix_batch/")
    ...
    parser.add_argument("--output_dir", type=str, default="./cache/models/experiments/fpan_unseen_mix_batch/")
