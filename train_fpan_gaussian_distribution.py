...
def create_train_loader(args, device, all_experts, upan, train_loader):
    ...
    print("Expert1 count: ", fpan_target.tolist().count(0))
    print("Expert2 count: ", fpan_target.tolist().count(1))
...
def train_fpan(args):
    ...
    for _ in range(8000):
        ...
        x = transform(x)
        dataset.append((x,_))
    gaussian_train_loader_noshuffle = DataLoader(dataset, batch_size=args.batch_size, shuffle=False)
    ...
    gaussian_3_channel_train_loader_noshuffle = DataLoader(dataset_rgb, batch_size=args.batch_size, shuffle=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_dir", type=str, default="./results/experiments/fpan_gaussian_distribution/")
    ...
    parser.add_argument("--output_dir", type=str, default="./cache/models/experiments/fpan_gaussian_distribution/")
