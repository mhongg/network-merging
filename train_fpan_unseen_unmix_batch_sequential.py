...
def train(args, fpan, train_loader, optimizer, epoch, task_idx):
    fpan.train()
...
def train_model(fpan, trial, device, expert_arch, train_loaders, test_loaders, target_create_fn, config_args):
    ...
    for epoch in range(1, config_args.epochs + 1):
        ...
        for task_idx, fpan_train_loader in enumerate(fpan_train_loaders):
            # Train fpan
            train(config_args, fpan, fpan_train_loader, optimizer, epoch, task_idx)
    ...
    return fpan, avg_test_loss, avg_acc
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_dir", type=str, default="./results/experiments/fpan_unseen_unmix_batch_sequential/")
    ...
    parser.add_argument("--output_dir", type=str, default="./cache/models/experiments/fpan_unseen_unmix_batch_sequential/")
