...
from fmnist_kmnist.dataloaders import (
    fmnist_kmnist_train_loader, 
    fmnist_kmnist_test_loader,
)
from archs.lenet5 import LeNet5, LeNet5Halfed
from archs.resnet import ResNet18, ResNet34
from archs.vgg import VGG11, VGG19
import time
...
def train_fpan(args):
    ...
    if args.fpan_data == "disjoint_mnist":
        train_loaders = mnist_combined_train_loader(args.batch_size)
        ...
        train_loaders = mnist_cifar10_single_channel_train_loader(args.batch_size)
        ...
        train_loaders = fmnist_kmnist_train_loader(args.batch_size)
    ...
    if args.fpan_arch == "resnet18":
        fpan_arch = ResNet18
    elif args.fpan_arch == "resnet34":
        fpan_arch = ResNet34
    elif args.fpan_arch == "vgg11":
        fpan_arch = VGG11
    elif args.fpan_arch == "vgg19":
        fpan_arch = VGG19
    ...
    for i in range(len(args.seeds)):
        ...
        if args.save_models:
            torch.save(
                fpan.state_dict(),
                args.output_dir
                + f"fpan_{args.fpan_data}({fpan_input_channel})_{args.fpan_arch}_(wrong pct={args.wrong_target_pct}){args.seeds[i]}",
            )
    ...
    if args.save_results:
        save_results(
            f"fpan_{args.fpan_data}({fpan_input_channel})_{args.fpan_arch}_(wrong pct={args.wrong_target_pct})",
            fpan_results,
            args.results_dir,
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="resnet18",
        choices=["lenet5", "lenet5_halfed", "resnet18", "resnet34", "vgg11", "vgg19"],
    )
    ...
    parser.add_argument("--results_dir", type=str, default="./results/experiments/fpan_trained_with_wrong_target/")
    parser.add_argument("--output_dir", type=str, default="./cache/models/experiments/fpan_trained_with_wrong_target/")
