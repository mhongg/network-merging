...
def train_main(args):
    ...
    if args.dataset == "first5_mnist":
        ...
        train_loader = fmnist_train_loader(args.batch_size)
        test_loader = fmnist_test_loader(args.test_batch_size)
        args.output_size = 10
        args.input_channel = 1
    elif args.dataset == "kmnist":
        train_loader = kmnist_train_loader(args.batch_size)
        test_loader = kmnist_test_loader(args.test_batch_size)
        args.output_size = 10
        args.input_channel = 1
